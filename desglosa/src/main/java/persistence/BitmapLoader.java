...
public class BitmapLoader {
    public static BufferedImage loadBitmap(String file) throws IOException {
        ...
        try {
            ...
            if (nBitCount == 24) {
                ...
                image = read8BitBitmap(nColoursUsed, nBitCount, nSizeImage,
    ...
    private static BufferedImage read8BitBitmap(int nColoursUsed,
            int nBitCount, int nSizeImage, int nWidth, int nHeight,
        ...
        DataBufferInt dataBufferByte = ((DataBufferInt) bufferedImage
    ...
    private static BufferedImage read24BitBitmap(int nSizeImage, int nHeight,
            int nWidth, InputStream input) throws IOException {
        ...
        DataBufferByte dataBufferByte = ((DataBufferByte) bufferedImage
                .getRaster().getDataBuffer());
