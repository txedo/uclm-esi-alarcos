...
\begin{itemize}
	...
	\item \textbf{Clase Role} (Véase Anexo \ref{anexo:role}). En este caso no se presenta ningún tipo de asociación, por lo que en esta clase sólo será necesario implementar el \textit{interface} GrantedAuthority de Spring Security y realizar su correspondiente mapeo con la tabla \textit{roles} mediante JPA.
