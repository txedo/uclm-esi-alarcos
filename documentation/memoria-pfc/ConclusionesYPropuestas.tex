...
\begin{itemize}
	...
	\item Diseño de mecanismos que permiten que la herramienta sea fácilmente adaptable a nuevos requisitos de visualización por parte de la empresa.
\end{itemize}
...
\begin{itemize}
	...
	\item Manejo de la persistencia mediante \textbf{Hibernate} y \textbf{JPA}.
	
	\item Desarrollo de aplicaciones web basadas en \textbf{Struts2}.
...
Para finalizar, destacar los conocimientos docentes adquiridos en informática gráfica, ingeniería del software y bases de datos.