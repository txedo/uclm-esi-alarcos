...
\imagenBorde{Cap5//it1-jogl-usecase}{1.2}{Diagrama de casos de uso para un mini-proyecto de funcionalidad reducida, basado en JOGL}{fig:it1-jogl-usecase}
...
\imagenBorde{Cap5//it1-analysis-class-diagram}{1.2}{Diagrama de clases de análisis para un mini-proyecto de funcionalidad reducida, basado en JOGL}{fig:it1-analysis-class-diagram}

\imagenBorde{Cap5//it1-communication-class-diagram}{1.1}{Diagrama de comunicación para un mini-proyecto de funcionalidad reducida, basado en JOGL}{fig:it1-communication-class-diagram}
...
\imagenBorde{Cap5//it1-jogl-class-diagram}{0.8}{Diagrama de clases de diseño  para un mini-proyecto de funcionalidad reducida, basado en JOGL}{fig:it1-jogl-class-diagram}
