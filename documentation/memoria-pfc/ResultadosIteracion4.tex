...
Durante esta disciplina se implementan los casos de uso CdU1.5 y CdU1.6, tal y como se estableció en el plan de iteraciones. No se adjuntan detalles de implementación para no extender el documento en exceso, pero sí se incluye una captura de pantalla para mostrar la evolución del motor gráfico (Fig. \ref{fig:it4-jogl-screenshot}).
