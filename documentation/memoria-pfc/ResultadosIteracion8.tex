...
\imagenBorde{Cap5//it8-management-usecase-diagram}{0.9}{Diagrama de casos de uso para CdU2.3 y CdU2.4}{fig:it8-management-usecase-diagram}
...
\imagenBorde{Cap5//it8-company-create-communication-diagram}{2.1}{Diagrama de comunicación para CdU2.3 (Crear compañía)}{fig:it8-company-create-communication-diagram}

\imagenBorde{Cap5//it8-company-view-communication-diagram}{2.1}{Diagrama de comunicación para CdU2.3 (Ver compañía)}{fig:it8-company-view-communication-diagram}
...
\imagenBorde{Cap5//it8-company-create-sequence-diagram}{2.1}{Diagrama de secuencia para CdU2.3 (Crear compañía)}{fig:it8-company-create-sequence-diagram}

\imagenBorde{Cap5//it8-company-view-sequence-diagram}{2.1}{Diagrama de secuencia para CdU2.3 (Ver compañía)}{fig:it8-company-view-sequence-diagram}
