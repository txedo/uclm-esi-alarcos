...
<body id="showSubproject" class="">
	<div>
		...
		<c:if test="${(empty param.id and not fn:contains(requestScope['javax.servlet.forward.servlet_path'],'/editSubproject')) or not empty param.factoryId or not empty param.projectId}">
