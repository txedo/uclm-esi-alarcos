...
*/
public class MyXmlDataSetWriter implements IDataSetConsumer
{
   ...
   public MyXmlDataSetWriter(Writer writer)
   {
       _xmlWriter = new XmlWriter(writer);
       _xmlWriter.enablePrettyPrint(true);
   }

   public MyXmlDataSetWriter(Writer writer, String encoding)
   {
           ...
           for (int i = 0; i < columns.length; i++)
           {
               ...
               else
               {
                   try
                   {
                       ...
                       _xmlWriter.writeAttribute(DESCRIPTION, columnName);
