...
\imagen{Cap5//it3-eer-model}{0.35}{Modelo Entidad-Relación Extendido}{fig:it3-eer-model}

\imagenBorde{Cap5//it3-knowledge-class-diagram}{0.65}{Diagrama de clases de conocimiento para el contexto del desarrollo global}{fig:it3-knowledge-class-diagram}
...
\imagenBorde{Cap5//it3-property-annotation-parser-class-diagram}{0.8}{Diagrama de clases de la anotación Property y su correspondiente analizador}{fig:it3-property-annotation-parser-class-diagram}
