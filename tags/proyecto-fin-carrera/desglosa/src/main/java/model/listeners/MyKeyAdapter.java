...
public class MyKeyAdapter extends KeyAdapter {
    ...
    public void keyPressed(KeyEvent e) {
        /*
         * FLECHA_ARRIBA desplazar hacia delante FLECHA_ABAJO desplazar hacia
         * atras FECHA_IZQUIERDA desplazar a la izquierda FELCHA_DERECHA
         * desplazar a la derecha CTRL + FLECHA_ARRIBA rotar la camara hacia
         * arriba CTRL + FLECHA_ABAJO rotar la camara hacia abajo CTRL +
         * FLECHA_IZQUIERDA rotar la camara hacia la izquierda CTRL +
         * FLECHA_DERECHA rotar la camara hacia la derecha SUMA aumentar zoom
         * RESTA disminuir zoom
         */
        switch (e.getKeyCode()) {
        case KeyEvent.VK_F10:
            this.drawer.setStencilShadow(!this.drawer.isStencilShadow());
            System.err.println("Stencil shadow: "
                    + this.drawer.isStencilShadow());
            break;
        case KeyEvent.VK_F11:
            this.drawer.setRenderShadow(!this.drawer.isRenderShadow());
            System.err
                    .println("Render shadow: " + this.drawer.isRenderShadow());
            break;
