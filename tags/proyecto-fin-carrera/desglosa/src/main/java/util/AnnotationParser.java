...
public final class AnnotationParser {
    ...
    public static final Map<String, String> parse(final String clazz) throws Exception {
        return parse(Class.forName(clazz));
    }

    public static final Map<String, String> parse(final Class<?> clazz) throws Exception {
