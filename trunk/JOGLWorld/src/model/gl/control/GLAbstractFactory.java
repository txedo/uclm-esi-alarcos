...
public abstract class GLAbstractFactory {
	...
	public abstract GLObject createMapLocation(float pos_x, float pos_y);
	public abstract GLObject createMapLocation (float pos_x, float pos_y, float size, Color color);
