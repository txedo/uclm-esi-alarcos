...
El objetivo de estas reuniones ha consistido en determinar los requisitos que la herramienta debe satisfacer, así como las metáforas de visualización a desarrollar y las dimensiones a visualizar, cuyo resultado se muestra en la sección \ref{sec:arquitectura-dgs}.
...
Por último, señalar que la funcionalidad de Maven es cada vez más amplia gracias a la posibilidad de creación e incorporación de plugins y ya existente variedad de los mismos.
...
MySQL Workbench \cite{site:mysql-workbench} (Fig. \ref{fig:mysql-workbench}) es una herramienta que permite diseñar, configurar y administrar bases de datos y servidores de bases de datos de un modo sencillo e intuitivo. Para ello proporciona al usuario funcionalidades para modelado de datos, administración de usuarios, etcétera.
...
\BibTeX \cite{site:bibtex} es, paralelamente, una herramienta y un formato de fichero que se emplea para gestionar la bibliografía y referencias de documentos generados con \LaTeX{}.
