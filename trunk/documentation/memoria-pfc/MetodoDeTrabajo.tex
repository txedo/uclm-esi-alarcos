...
\imagen{Cap4//mysql-workbench}{1.2}{Captura de pantalla de la herramienta MySQL Workbench 5.2 CE}{fig:mysql-workbench}
...
\imagen{Cap4//visual-paradigm}{1.2}{Captura de pantalla de la herramienta Visual Paradigm 8.0}{fig:visual-paradigm}
...
Se trata de un framework dedicado a la \textbf{automatización de pruebas unitarias} para aplicaciones basadas en Java. Además, se integra perfectamente con Maven para la generación de informes de pruebas y de cobertura de código.
