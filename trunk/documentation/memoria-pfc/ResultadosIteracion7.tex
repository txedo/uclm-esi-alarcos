...
\imagenBorde{Cap5//it7-profile-usecase-diagram}{1.1}{Diagrama de casos de uso para CdU2.2}{fig:it7-profile-usecase-diagram}
...
\imagenBorde{Cap5//it7-profile-communication-class-diagram}{0.75}{Diagrama de comunicación para CdU2.2 (Crear perfil de visualización)}{fig:it7-profile-communication-class-diagram}
...
\imagenBorde{Cap5//it7-configure-profile-ui}{0.9}{Prototipo de la interfaz gráfica para CdU2.2 (Crear perfil de visualización)}{fig:it7-configure-profile-ui}
...
\imagenBorde{Cap5//it7-profile-class-diagram}{1.1}{Diagrama de clases de dominio para CdU2.2}{fig:it7-profile-class-diagram}
...
En la figura  \ref{fig:it7-testing-architecture} se muestra el diagrama de clases de la arquitectura de pruebas propuesta. En la parte superior del diagrama se muestran las librerías de terceros que serán utilizadas. En la parte central, enmarcado por el paquete \textit{test.util}, se muestran las clases que deberán ser implementadas para obtener los servicios requeridos de dichas librerías. Y en la parte inferior se muestran las clases que se corresponden con los \textit{test suites} de acciones, dominio, conocimiento y DAO que contienen los casos de prueba a implementar.

\imagen{Cap5//it7-testing-architecture}{1.4}{Diagrama de clases de la arquitectura de pruebas unitarias}{fig:it7-testing-architecture}
...
Un aspecto importante de la etapa de pruebas consiste en conocer cuánto código ha sido probado mediante la implementación de las mismas. Para ello, es posible generar su correspondiente informe mediante un plugin de Maven denominado \textit{cobertura-maven-plugin}. Este plugin no requiere configuración y deberá ser añadido en la sección \textit{reporting} del fichero pom.xml (Listado \ref{lst:pom-cobertura}). Por otro lado, para obtener un informe de pruebas y conocer el resultado de ejecución de las mismas, así como diferentes estadísticas se utiliza \textit{maven-surefire-report-plugin}.
...
\imagenBorde{Cap5//screenshot-login-testsuite}{0.7}{Estructura del \textit{test suite} para CdU2.1}{fig:screenshot-login-testsuite}
