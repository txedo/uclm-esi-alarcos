...
En la literatura se encuentran distintas técnicas que permiten representar visualmente determinados tipos de información relacionada con el software. \cite{fj98} y \cite{hvvw05} utilizan modelos en tres dimensiones para mostrar información estadística. \cite{wl07} emplea la metáfora de una ciudad en tres dimensiones para representar medidas software (Fig. \ref{fig:city-metaphore}). \cite{lanza03} combina vistas polimétricas con medidas software de las entidades conceptuales que intervienen en programas software orientado a objetos (clases, atributos, métodos...). En definitiva, la estrategia que se persigue consiste en asociar atributos gráficos (textura, color, ubicación, tamaño, etcétera) con los datos que se quiere representar, pero hay que controlar determinadas características para evitar introducir ruido (Fig. \ref{fig:edge-noise}) y exceso de información en la visualización. Estos dos factores interfieren en la inspección visual haciendo que no sea eficiente y no se pueda hacer uso de los \textit{procesos preatentos} \cite{hea92}.
