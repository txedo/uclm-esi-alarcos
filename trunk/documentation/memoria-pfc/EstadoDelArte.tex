...
Como ya se ha comentado anteriormente, este paradigma de desarrollo de software es vulnerable a determinados factores que pueden afectar a un incremento del presupuesto del producto final, así como retrasos en su entrega. Según \cite{krishna:managing}, \cite{layman06} y \cite{herb-moitra-2001} estos problemas se pueden clasificar de la siguienet manera:
...
\imagenBorde{Cap3//opengl-tex-shadow-reflect-example}{0.7}{Ejemplo renderizado con OpenGL que muestra texturas, sombras y reflejos}{fig:opengl-tex-shadow-reflect-example}
