...
Durante esta disciplina se analiza cómo resolver dos de las cuestiones que han surgido en referencia al motor gráfico: errores de visualización en las transparencias de las metáforas y cálculo de sombras en tiempo real. Ambos casos tienen una estrecha relación con la posición de la cámara en la escena.
...
\imagenBorde{Cap5//it6-access-control-usecase-diagram}{1.3}{Diagrama de casos de uso para CdU2.1 (Iniciar sesión)}{fig:it6-access-control-usecase-diagram}
...
\imagenBorde{Cap5//it6-access-control-analysis-class-diagram-login}{1.2}{Diagrama clases de análisis para CdU2.1 (Iniciar sesión)}{fig:it6-access-control-analysis-class-diagram-login}

\imagenBorde{Cap5//it6-access-control-communication-class-diagram-login}{1.0}{Diagrama de comunicación para CdU2.1 (Iniciar sesión)}{fig:it6-access-control-communication-class-diagram-login}

\imagenBorde{Cap5//it6-access-control-sequence-class-diagram-login}{1.0}{Diagrama de secuencia para CdU2.1 (Iniciar sesión)}{fig:it6-access-control-sequence-class-diagram-login}
...
\imagenBorde{Cap5//it6-access-control-class-diagram-spring-security}{1.0}{Diagrama de clases de diseño para CdU2.1 (GBAC mediante Spring Security)}{fig:it6-access-control-class-diagram-spring-security}
