...
No obstante, en este caso surge una ligera diferencia a la hora de analizar las clases que consiste en las asociaciones que existirán entre las diferentes clases del dominio. Esta característica se observa perfectamente en el modelo EER (Fig. \ref{fig:it3-eer-model}). De modo que, a la hora de configurar un perfil para una entidad, puede resultar interesante la posibilidad de incluir información acerca de las medidas o indicadores de sus entidades asociadas. Para lograr esta funcionalidad se añade el atributo \textit{embedded} a la anotación \textit{PropertyAnnotation}, que indicará al analizador si debe emplear el método de introspección sobre la clase del atributo anotado. Esta solución permite, nuevamente, analizar las entidades en tiempo de ejecución y adaptar la interfaz gráfica de usuario a sus necesidades.
...
\imagenBorde{Cap5//struts2-archetype-starter}{0.55}{Estructura de un proyecto Maven con arquetipo struts2-archetype-starter}{fig:struts2-archetype-starter}
