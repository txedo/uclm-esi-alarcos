En esta iteración (Tabla \ref{table:ficha-iteracion-3}), que se centra en el componente correspondiente con la aplicación web, se aborda:
\begin{itemize}
