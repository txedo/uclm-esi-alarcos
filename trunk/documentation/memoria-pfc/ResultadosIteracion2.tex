...
El aspecto visual de un modelo gráfico estará condicionado por los valores que toman sus dimensiones. Se entiende como \textbf{dimensión} de un un modelo a aquel atributo cuyo valor afecta directamente en su representación visual. Las dimensiones se emplearán a la hora de crear los perfiles de visualización para poder asociarlos con los atributos de las entidades de dominio del DGS. Así pues, se debe encontrar un mecanismo que permita diferenciar qué atributos de los elementos de una metáfora actúan como dimensiones y cuáles no.
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	...
	\item La cámara se desplaza hacia delante.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla S del teclado o hace clic izquierdo con el ratón mientras lo arrastra hacia atrás.
	\item La cámara se desplaza hacia atrás.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline
	...
	\item La cámara se desplaza en dirección lateral hacia la izquierda.
	\vspace{-6mm}
	\end{enumerate} 
	\\
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla E del teclado o hace clic izquierdo con el ratón mientras lo arrastra hacia la derecha.
	\item La cámara se desplaza en dirección lateral hacia la derecha.
	\vspace{-6mm}
	\end{enumerate} 
	\\
	\hline
	...
	\item La cámara se desplaza en sentido vertical hacia abajo.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la barra de espacio del teclado.
	\item La cámara se desplaza en sentido vertical hacia arriba.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline 
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	\hline
	\textbf{Identificador}: CdU1.2 \\
	\hline
	\textbf{Nombre}: Rotar (Cámara) \\
	\hline
	\textbf{Descripción}: Funcionalidad para que un usuario pueda rotar la cámara y cambiar la dirección de enfoque en un entorno 3D. \\
	\hline
	\textbf{Precondiciones}: Ninguna. \\
	\hline
	\textbf{Post-condiciones}: La cámara cambia la dirección de enfoque. \\
	\hline 
	\textbf{Escenario 1:}
	\vspace{-4mm}
	\begin{enumerate}
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla \textit{RePag} del teclado o hace clic derecho con el ratón mientras lo arrastra hacia arriba.
	\item La cámara rota cambiando su dirección de enfoque hacia arriba.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla \textit{AvPag} del teclado o hace clic derecho con el ratón mientras lo arrastra hacia abajo.
	\item La cámara rota cambiando su dirección de enfoque hacia abajo.
	\vspace{-6mm}
	\end{enumerate} 
	\\	
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla A del teclado o hace clic derecho con el ratón mientras lo arrastra hacia la izquierda.
	\item La cámara rota cambiando su dirección de enfoque hacia la izquierda.
	\vspace{-6mm}
	\end{enumerate} 
	\\
	\hline
	...
	\setlength{\partopsep}{\itemsep}
	\setlength{\topsep}{0pt}
	\item El usuario pulsa la tecla D del teclado o hace clic derecho con el ratón mientras lo arrastra hacia la derecha.
	\item La cámara rota cambiando su dirección de enfoque hacia la derecha.
	\vspace{-6mm}
	\end{enumerate} 
	\\
	\hline
\end{tabular}
\caption{Descripción del caso de uso CdU1.2}
\label{table:rotate-usecase-description}
\end{table}
...
\imagenBorde{Cap5//it2-camera-spotlight-class-diagram}{0.7}{Diagrama de clases de diseño para CdU1.1 y CdU1.2}{fig:it2-camera-spotlight-class-diagram}
...
\imagenBorde{Cap5//it2-scene-class-diagram}{0.5}{Diagrama de clases de diseño para CdU1.5}{fig:it2-scene-class-diagram}
...
\vspace{7mm}
\textbf{Dimensiones de los modelos gráficos}

Se plantea diseñar cada modelo gráfico como una clase Java. Como es habitual, una clase Java contiene un conjunto de atributos que definen el estado de los objetos que se instancian. Para poder diferenciar qué atributos pueden ser empleados como dimensiones, así como para dotar la dimensión de la semántica que se crea necesaria, se propone anotar los atributos de la clase con \textbf{anotaciones personalizadas de Java}.
...
\imagenBorde{Cap5//it2-dimension-annotation-parser-class-diagram}{0.8}{Diagrama de clases de la anotación GLDimension y su correspondiente analizador}{fig:it2-dimension-annotation-parser-class-diagram}
