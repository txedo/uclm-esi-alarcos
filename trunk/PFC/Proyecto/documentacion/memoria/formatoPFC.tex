...
\newcommand{\director}{Moisés Rodriguez Monje}
\newcommand{\tutor}{M\textordfeminine{} Ángeles Moraga de la Rubia}
\newcommand{\titulopfc}{Cuadro de Mando para la Visualización de la Calidad del Software, Integrado con un Entorno de Medición}
