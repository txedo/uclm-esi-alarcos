...
Aunque se han tenido en cuenta librerías como jQuery, jQuery UI, YUI (Yahoo! UI Library) y GWT (Google Web Toolkit), y no se descarta la posibilidad de utilizarlas en algún momento, se ha optado por profundizar en las que se enumeran a continuación debido al gran uso que se hace de ellas en el mundo empresarial.
